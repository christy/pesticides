...
Data Notes: 
<ul>
<li>Pesticide Use Report (PUR) includes fields such as: </li>
...
<li>Note: CDPR county codes:  Sonoma = 49 </li>
<li>Note: CDPR commodity codes:  Wine grape = 29143, Apple = 4001 </li>
<li>Conversion to pounds:  gallons product used * density * specific gravity, where 
Product technical fields were taken from the CDPR product database. </li>
  </ul>
